            ...
            <div ref='product' class='product'>
                ...
                <div class='product-desc'>
                    <div class='text-content'>
                            ...
                            <span class='table-row'><span class='parameter'>Категория:</span><span class='value'><a href='/izibuy/yahooshopping/search.php?c=$category'>$category</a></span></span>
                    </div>
            ...
            echo '
                <div class="item">
                    ...
                    <div class="item-image">
                        ...
                        <div class="zoom" idx="'.$id.'" @click="thumb"></div>
                    </div>
                    <a href="./item.php?item='.$id.'" target="_blank" class="item-description">'.$title.'</a>
